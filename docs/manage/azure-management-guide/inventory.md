...
To najważniejsza dyscyplina, ponieważ zebranie odpowiednich danych operacyjnych ma kluczowe znaczenie podczas podejmowania decyzji dotyczących operacji. Zespoły zarządzania chmurą muszą wiedzieć, jakimi zasobami zarządzają i jak są obsługiwane te zasoby. W tym artykule omówiono różne narzędzia, które zapewniają wgląd w stan uruchomienia zasobów oraz umożliwiają tworzenie spisu tych zasobów.
...
|Śledzenie zmian i spisu maszyn wirtualnych|Usługa Azure Change Tracking and Inventory|Tworzenie spisu maszyn wirtualnych i monitorowanie zmian na poziomie systemu operacyjnego gościa|
|Service Health|Dziennik aktywności platformy Azure|Monitorowanie zmian na poziomie subskrypcji|
...
W poszczególnych artykułach znajdują się instrukcje dołączania następujących rozwiązań:
...
Wszystkie wymienione rozwiązania ułatwiają skonfigurowanie spisu i widoczności.
