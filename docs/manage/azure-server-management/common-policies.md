...
Za pomocą tego skryptu można również zastosować inne zasady omówione w tym artykule. Wystarczy zamienić identyfikator GUID w wierszu, który `$AllowedLocationPolicy` ustawia identyfikator GUID zasad, które chcesz zastosować.
