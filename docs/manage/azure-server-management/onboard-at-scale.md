...
1. W Azure Portal przejdź do pozycji **Azure Policy** > **przypisania**@no__t **-3.**
...
1. W Azure Portal Otwórz **wszystkie usługi** i wybierz pozycję **Management + Zarządzanie** > **rozwiązania**.
