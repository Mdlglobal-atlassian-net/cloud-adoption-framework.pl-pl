...
- Przeprowadź [Przegląd zasad](../../governance/policy-compliance/what-is-a-cloud-policy-review.md) , aby rozpocząć proces modernizacji istniejących firmowych zasad zabezpieczeń IT i zdefiniować zasady MVP dotyczące znanych zagrożeń.
...
- Oceń zasady dostępu o [najniższych uprawnieniach](/azure/active-directory/users-groups-roles/roles-delegate-by-task) organizacji i korzystaj z ról opartych na zadaniach, aby zapewnić dostęp do określonych zasobów.
...
> [wprowadzenie do zabezpieczeń platformy Azure](/azure/security/azure-security)
> [o rejestrowaniu, raportowaniu i monitorowaniu](../../decision-guides/log-and-report/index.md)
