...
4. Na każdym poziomie tej hierarchii grupowania należy stosować [spójną nomenklaturę](../../../ready/considerations/name-and-tag.md).

Oto przykład zastosowania tego wzorca:

![Przykład organizacji zasobów dla średniej firmy](../../../_images/governance/mid-market-resource-organization.png)
...
- [Mechanizmy kontroli na potrzeby rozwoju środowiska wielochmurowego](./multicloud-evolution.md)
...
![Przykład programu MVP ładu przyrostowego](../../../_images/governance/governance-evolution.png)
