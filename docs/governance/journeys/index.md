...
description: Poznaj przewodniki dotyczące zapewniania ładu z możliwością działania udostępniane w przewodniku Cloud Adoption Framework.
...
Aby uzyskać więcej informacji, odwiedź sekcję [wirtualnego centrum danych Azure](/azure/architecture/vdc) w witrynie Cloud Adoption Framework.
...
> [Standardowy przewodnik dotyczący ładu](./standard-enterprise/index.md)
>
> [Przewodnik dotyczący ładu dla przedsiębiorstw złożonych](./complex-enterprise/index.md)
