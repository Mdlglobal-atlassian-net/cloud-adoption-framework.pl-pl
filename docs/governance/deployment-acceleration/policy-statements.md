...
**Potencjalne opcje projektu:** [Szablony Azure Resource Manager](/azure/azure-resource-manager/resource-group-overview#template-deployment) udostępniają podejście "infrastruktura jako kod" do wdrażania zasobów na platformie Azure. [Bloki konstrukcyjne platformy Azure](https://github.com/mspnp/template-building-blocks/wiki) udostępniają narzędzie wiersza polecenia i zestaw szablonów Menedżer zasobów zaprojektowanych w celu uproszczenia wdrażania zasobów platformy Azure.
