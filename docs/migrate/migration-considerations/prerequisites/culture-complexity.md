...
description: Przygotowanie na złożoność kulturową — wyrównywanie ról i obowiązków.
...
W każdym scenariuszu warto zainwestować w dokumentację ról i obowiązków wymaganych do przeprowadzenia migracji. W tym artykule opisano niektóre role i obowiązki występujące w ramach migracji centrum danych, które służą jako szablon dokumentacji ułatwiający zapewnianie przejrzystości w trakcie procesu.
...
| Ocena | Justowanie | Zweryfikuj założenia będące podstawą zmieniających się uzasadnień biznesowych. |
| Oceń | Ryzyko | Pomóż zespołowi wdrożeniowemu ds. chmury zrozumieć wpływ rzeczywistego ryzyka biznesowego. |
| Oceń | Zatwierdzenie | Sprawdź i zatwierdź wpływ proponowanych zmian architektury na firmę. |
