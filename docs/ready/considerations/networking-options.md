...
- **Czy obciążenia będą dostępne za pośrednictwem Internetu?** Platforma Azure zapewnia usługi mające na celu pomoc w zarządzaniu dostępem zewnętrznym do aplikacji i usługi oraz jego zabezpieczeniu:
  ...
  - [Usługa Azure Traffic Manager](https://docs.microsoft.com/azure/traffic-manager/traffic-manager-overview)
...
| Chcę zoptymalizować dostarczanie z farm serwerów aplikacji przy jednoczesnym zwiększeniu bezpieczeństwa aplikacji za pomocą zapory aplikacji sieci Web. | [Azure Application Gateway](https://docs.microsoft.com/azure/application-gateway) <br> [Azure Front Door Service](https://docs.microsoft.com/azure/frontdoor) |
| Chcę bezpiecznie korzystać z Internetu w celu uzyskania dostępu do sieci Azure Virtual Network za pomocą bram sieci VPN o wysokiej wydajności. | [Brama sieci VPN platformy Azure](https://docs.microsoft.com/azure/vpn-gateway) |
...
| Chcę przyspieszyć dostarczanie zawartości o wysokiej przepustowości do klientów na całym świecie — od aplikacji i przechowywanej zawartości, po przesyłanie strumieniowe filmów wideo. | [Usługa Azure Content Delivery Network](https://docs.microsoft.com/azure/cdn) |
| Chcę chronić moje aplikacje platformy Azure przed atakami DDoS. | [Ochrona za pomocą usługi Azure DDoS](https://docs.microsoft.com/azure/virtual-network/ddos-protection-overview) |
| Chcę w sposób optymalny dystrybuować ruch do usług w obrębie globalnych regionów platformy Azure, zapewniając wysoką dostępność i krótki czas reakcji. | [Usługa Azure Traffic Manager](https://docs.microsoft.com/azure/traffic-manager) <br><br> [Azure Front Door Service](https://docs.microsoft.com/azure/frontdoor) |
...
- Należy włączyć funkcje wdrażania Agile dla obciążeń, aby obsługiwać deweloperów i zespołów operacyjnych przy zachowaniu wspólnych zasad i zgodności z przepisami oraz centralną kontrolę IT w ramach usług podstawowych.
