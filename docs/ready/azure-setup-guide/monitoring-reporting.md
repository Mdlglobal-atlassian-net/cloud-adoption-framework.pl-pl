...
description: Dowiedz się, jak skonfigurować monitorowanie, raportowanie i alerty dla środowiska zarządzania platformy Azure przy użyciu podręcznika Cloud Adoption Framework dla platformy Azure.
author: timleyden
ms.author: tileyden
ms.date: 04/09/2019
ms.topic: guide
