...
4. **Przejrzyj decyzje dotyczące racjonalizacji:** Przejrzyj decyzje dotyczące racjonalizacji, aby uściślić decyzje dotyczące ścieżki wdrożenia: Migruj lub innowacje.
5. **Ustanów iteracje i plany wydań:** _iteracje_ to bloki czasu przydzielono do pracy. _Wersje_ są definicją pracy, która ma zostać wykonana przed zainicjowaniem zmiany w procesach produkcyjnych.
